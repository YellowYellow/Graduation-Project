...
var generateTableInfo = function(data) { 
        ...
        { 
            for (var i = 0; i < data.length; i++) { 
                ...
                //$('<p>asd</p>').appendTo($("#comment_list"));
                $('<div class="comment"><div class="avatar"><img src="../../Public/image/wxin.jpg"/></div><div class="comment_content_con"> <p class="comment_content">'+data[i]['comment']+'</p><p class="comment_date">'+data[i]['time']+'</p></div></div>').appendTo($(".comment_list"));        
            }; 
        }
