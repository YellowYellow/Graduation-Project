...
function get_jump_url($module_name)
{
    return get_url().'/tc/index.php/Login/index?jump='.$module_name;
}
...
function snailsubstr($str, $start, $end, $exd=false)
{
    $len = strlen($str);
    return ($exd&&$len>($end - $start))?mb_substr($str, $start, $end, 'utf-8')."...":mb_substr($str, $start, $end, 'utf-8'); //输出 我a
}